  ...
  fields: [
    {
      ...
      required: true,
      helpText:
        "Generate a key at https://xyra-chat.vercel.app/settings/api. Needs scopes appropriate for the triggers and actions you'll use (at minimum `contacts:read` + `messages:write` + `webhooks:write` for typical Zaps).",
    },
  ],
